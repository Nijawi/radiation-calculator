...
elements = FileAttachment("data/elements.csv").csv({typed: true})
locations = FileAttachment("data/locations.csv").csv({typed: true})
ages = FileAttachment("data/ages.csv").csv({typed: true})
genders = FileAttachment("data/genders.csv").csv({typed: true})
